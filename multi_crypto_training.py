...
# test function for testing the predictions on the test data
...
def test(start_date, end_date, ticker_list, data_source, time_interval,
    ...
    env_config = {
        ...
        "tech_array": tech_array,
        "turbulence_array": turbulence_array,
        "if_train": False,"env_name": "multicrypto_env"
    }
    ...
    if drl_lib == "elegantrl":
        episode_total_assets = DRLAgent_erl.DRL_prediction(
            ...
            environment=env_instance,env_args=env_config
        )
...
TICKER_LIST = ['BTCUSDT','ETHUSDT','ADAUSDT','BNBUSDT','XRPUSDT',
                'SOLUSDT','SHIBUSDT', 'DOGEUSDT','AVAXUSDT']
env = CryptoEnv
TRAIN_START_DATE = '2024-01-01'#yyyy-mm-dd
TRAIN_END_DATE = '2024-05-01'

TEST_START_DATE = '2024-05-02'
TEST_END_DATE = '2024-5-15'
...
# testing the trained model for unseen data: 
