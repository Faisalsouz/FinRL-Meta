...
export default function BinancePaperTradingPage() {                                                                                                                                                
  const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL;                                                                                                                                       
                                                                                                                                                                                                   
  // Form state                                                                                                                                                                                    
  const [tickerList, setTickerList] = useState("SOLUSDT");                                                                                                                                         
  ...
  //const [logFilePath, setLogFilePath] = useState("/papertrading_crypto/papertrading_binance.log");                                                                                              
  ...
  const handleSubmit = async (event: React.FormEvent) => {                                                                                                                                         
    ...
    const payload = {                                                                                                                                                                              
      ...
      trade_budget: Number(tradeBudget),                                                                                                                                                           
    ...
    try {                                                                                                                                                                                          
      const res = await fetch(`${API_BASE_URL}/binance_paper_trade`, {                                                                                                                             
        method: "POST",                                                                                                                                                                            
  ...
  const handleStopPaperTrading = async () => {                                                                                                                                                     
    ...
    try {                                                                                                                                                                                          
      const res = await fetch(`${API_BASE_URL}/stop_binance_paper_trade`, {                                                                                                                        
        method: "POST",                                                                                                                                                                            
        headers: { "Content-Type": "application/json" },                                                                                                                                           
      });                                                                                                                                                                                          
      if (!res.ok) {                                                                                                                                                                               
  ...
  return (                                                                                                                                                                                         
    <div>                                                                                                                                                                                          
      <h1 className="text-2xl font-bold mb-4">Binance Paper Trading Form</h1>                                                                                                                      
      <form onSubmit={handleSubmit} className="space-y-4">                                                                                                                                         
        {/* Ticker List */}                                                                                                                                                                        
        <div>                                                                                                                                                                                      
          <label className="block font-medium mb-1">                                                                                                                                               
            Ticker List (comma-separated)                                                                                                                                                          
            <span data-tooltip-id="ticker-tooltip" data-tooltip-content="Currently supports only single asset.i.e format SOLUSDT" className="ml-2 text-blue-500 cursor-pointer">i</span>           
        ...
        <div>                                                                                                                                                                                      
          ...
          <span data-tooltip-id="time-tooltip" data-tooltip-content="the format must be in small 'min'i.e. 1min, 5min" className="ml-2 text-blue-500 cursor-pointer">i</span>                      
            </label>                                                                                                                                                                               
          <input                                                                                                                                                                                   
            type="text"                                                                                                                                                                            
            value={timeInterval}                                                                                                                                                                   
        ...
        <div>                                                                                                                                                                                      
          ...
          <span data-tooltip-id="cwd-tooltip" data-tooltip-content="Current Working Directory. Please don't change it if you are not developer!" className="ml-2 text-blue-500                     
cursor-pointer">i</span>                                                                                                                                                                           
        ...
        <div>                                                                                                                                                                                      
          <label className="block font-medium mb-1">                                                                                                                                               
            State Dim                                                                                                                                                                              
            <span data-tooltip-id="state-tooltip" data-tooltip-content="Calculated as: 1 (scaled price) + len(INDICATORS) (technical indicators) + 1 (previous step’s percentage change in price) +
1 (in-trade flag)" className="ml-2 text-blue-500 cursor-pointer">i</span>                                                                                                                          
        ...
        <div>                                                                                                                                                                                      
          <label className="block font-medium mb-1">                                                                                                                                               
            Action Dim                                                                                                                                                                             
            <span data-tooltip-id="action-tooltip" data-tooltip-content="Always equal to the number of assets, currently supports only single asset, so it should be 1" className="ml-2            
text-blue-500 cursor-pointer">i</span>                                                                                                                                                             
        ...
        {/* Trade Budget */}                                                                                                                                                                       
        <div>                                                                                                                                                                                      
          <label className="block font-medium mb-1">Trade Budget</label>                                                                                                                           
          <input                                                                                                                                                                                   
            type="number"                                                                                                                                                                          
            value={tradeBudget}                                                                                                                                                                    
            onChange={(e) => setTradeBudget(Number(e.target.value))}                                                                                                                               
            className="w-full rounded border border-gray-300 px-3 py-2 bg-white dark:bg-gray-800 text-black dark:text-white"                                                                       
          />                                                                                                                                                                                       
        </div>                                                                                                                                                                                     
